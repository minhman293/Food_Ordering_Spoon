...
public class ViewHistoryDetails extends AppCompatActivity {
    ...
    private void loadData() {
        User curentUser = User.getCurrentUser(ViewHistoryDetails.this);
...
//        listView.setFullHeight();
        new GetHistoryDetailTask(this,orderId).execute(getString(R.string.BASE_URL) + getString(R.string.API_GET_BILLS_BY_USER__GET, curentUser.getId()));
